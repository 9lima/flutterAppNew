...
//   Encryption({AesGcm? aesGcm}) : aesGcm = aesGcm ?? AesGcm.with256bits();

//   Future<AESDataModel> encrypt(List<int> msg, KeyModel keymodel) async {
//     try {
...
//       final randomList = uniqueRandomNumbers(seed, maxValue, count);
...
// List<int> uniqueRandomNumbers(int seed, int maxValue, int count) {
